...
public class GradesDDdoWhilewithoutmethod {
	...
	public static void main(String[] args) {
		        ...
		        do {
		            ...
		            boolean invalidRollNumber = false;
		            ...
		            if (studentData[i][0] > 0) {
		                ...
		                invalidRollNumber = true;
		            }
		            
		            int j = 1;
		            do {
		              /*  // Check for invalid marks
		                if (studentData[i][j] > 100) {
		            ...
		            if (validRollNumber && !invalidMarks) {  // Only calculate grade if roll number and marks are valid
		                char grade = 'X';
		                ...
		                System.err.println(" Invalid Roll number & No grade will be calculated");
		            }
		            i++;
